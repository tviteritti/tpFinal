...
<form action="<?php echo constant('URL');?>supervisor/actualizarProforma" method="POST">
    ...
    <input type="text" name="id_costeo" value="<?php echo $this->proforma->id_costeo;?>"><br>
    ...
    <input type="text" name="kilometros_r" value="<?php echo $this->proforma->kilometros_r;?>"><br>
    <input type="text" name="combustible_e" value="<?php echo $this->proforma->combustible_e;?>"><br>
    <input type="text" name="combustible_r" value="<?php echo $this->proforma->combustible_r;?>"><br>
    <input type="text" name="ETD_e" value="<?php echo $this->proforma->ETD_e;?>"><br>
    <input type="text" name="ETD_r" value="<?php echo $this->proforma->ETD_r;?>"><br>
    <input type="text" name="ETA_e" value="<?php echo $this->proforma->ETA_e;?>"><br>
    <input type="text" name="ETA_r" value="<?php echo $this->proforma->ETA_r;?>"><br>
    <input type="text" name="viaticos_e" value="<?php echo $this->proforma->viaticos_e;?>"><br>
    <input type="text" name="viaticos_r" value="<?php echo $this->proforma->viaticos_r;?>"><br>
    <input type="text" name="peajes_pesajes_e" value="<?php echo $this->proforma->peajes_pesajes_e;?>"><br>
    <input type="text" name="peajes_pesajes_r" value="<?php echo $this->proforma->peajes_pesajes_r;?>"><br> 
    <input type="text" name="extras_e" value="<?php echo $this->proforma->extras_e;?>"><br>
    <input type="text" name="extras_r" value="<?php echo $this->proforma->extras_r;?>"><br>
    <input type="text" name="hazard_e" value="<?php echo $this->proforma->hazard_e;?>"><br>
    <input type="text" name="hazard_r" value="<?php echo $this->proforma->hazard_r;?>"><br>
    <input type="text" name="reefer_e" value="<?php echo $this->proforma->reefer_e;?>"><br>
    <input type="text" name="reefer_r" value="<?php echo $this->proforma->reefer_r;?>"><br>
    <input type="text" name="fee_e" value="<?php echo $this->proforma->fee_e;?>"><br>
    <input type="text" name="fee_r" value="<?php echo $this->proforma->fee_r;?>"><br>
